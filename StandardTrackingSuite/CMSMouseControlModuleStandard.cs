...
{
    public class CMSMouseControlModuleStandard : CMSMouseControlModule
    {
        ...
        {
            CMSMouseControlModuleStandard newModule = new CMSMouseControlModuleStandard();
...
*/
        ...
        {
            StandardMouseControlPanel panel = new StandardMouseControlPanel();
